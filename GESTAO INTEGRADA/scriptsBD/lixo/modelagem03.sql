...
ALTER TABLE `ferpan`.`empresa` 
  ADD CONSTRAINT `fk_empresa_fantasia1`
  FOREIGN KEY (`ID_Fantasia` )
  REFERENCES `ferpan`.`fantasia` (`ID_Fantasia` )
  ON DELETE NO ACTION
  ON UPDATE NO ACTION, 
  ADD CONSTRAINT `fk_empresa_classificacao1`
  FOREIGN KEY (`ID_Classificacao` )
  REFERENCES `ferpan`.`classificacao` (`ID_Classificacao` )
  ON DELETE NO ACTION
  ON UPDATE NO ACTION
, ADD INDEX `fk_empresa_fantasia1` (`ID_Fantasia` ASC) 
, ADD INDEX `fk_empresa_classificacao1` (`ID_Classificacao` ASC) ;
