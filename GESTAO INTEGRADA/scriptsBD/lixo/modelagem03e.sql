...
ALTER TABLE `ferpan`.`manifesto` CHANGE COLUMN `GerDtEntrega` `GerDtEntrega` DATETIME NULL DEFAULT NULL  , CHANGE COLUMN `DtChegou` `DtChegou` DATETIME NULL DEFAULT NULL  , 
