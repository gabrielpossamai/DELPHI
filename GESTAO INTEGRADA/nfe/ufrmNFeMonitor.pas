...
procedure TfrmNFeMonitor.GravarConfiguracao;
Var IniFile : String ;
    Ini     : TIniFile ;
...
procedure TfrmNFeMonitor.LerConfiguracao;
Var IniFile  : String ;
    Ini     : TIniFile ;
    Ok : Boolean;
    StreamMemo : TMemoryStream;
...
procedure TfrmNFeMonitor.LoadXML(MyMemo: TMemo; MyWebBrowser: TWebBrowser);
begin
  MyMemo.Lines.SaveToFile(ExtractFileDir(application.ExeName)+'temp.xml');
  MyWebBrowser.Navigate(ExtractFileDir(application.ExeName)+'temp.xml');
end;

procedure TfrmNFeMonitor.sbtnCaminhoCertClick(Sender: TObject);
begin
...
procedure TfrmNFeMonitor.sbtnLogoMarcaClick(Sender: TObject);
begin
...
procedure TfrmNFeMonitor.sbtnPathSalvarClick(Sender: TObject);
var
  Dir: string;
begin
...
procedure TfrmNFeMonitor.FormCreate(Sender: TObject);
begin
 LerConfiguracao;
end;

procedure TfrmNFeMonitor.btnSalvarConfigClick(Sender: TObject);
begin
 GravarConfiguracao;
 LerConfiguracao;
end;

procedure TfrmNFeMonitor.btnStatusServClick(Sender: TObject);
begin
...
procedure TfrmNFeMonitor.btnConsultarClick(Sender: TObject);
begin
...
procedure TfrmNFeMonitor.btnCancNFClick(Sender: TObject);
var
  vAux : String;
begin
  OpenDialog1.Title := 'Selecione a NFE';
...
procedure TfrmNFeMonitor.btnValidarXMLClick(Sender: TObject);
begin
  OpenDialog1.Title := 'Selecione a NFE';
  OpenDialog1.DefaultExt := '*-nfe.XML';
  OpenDialog1.Filter := 'Arquivos NFE (*-nfe.XML)|*-nfe.XML|Arquivos XML (*.XML)|*.XML|Todos os Arquivos (*.*)|*.*';
...
procedure TfrmNFeMonitor.btnImprimirClick(Sender: TObject);
begin
  OpenDialog1.Title := 'Selecione a NFE';
  OpenDialog1.DefaultExt := '*-nfe.XML';
  OpenDialog1.Filter := 'Arquivos NFE (*-nfe.XML)|*-nfe.XML|Arquivos XML (*.XML)|*.XML|Todos os Arquivos (*.*)|*.*';
...
procedure TfrmNFeMonitor.btnCriarEnviarClick(Sender: TObject);
var
...
procedure TfrmNFeMonitor.btnInutilizarClick(Sender: TObject);
var
...
procedure TfrmNFeMonitor.ACBrNFe1StatusChange(Sender: TObject);
begin
...
procedure TfrmNFeMonitor.sbtnGetCertClick(Sender: TObject);
begin
...
procedure TfrmNFeMonitor.btnGerarNFEClick(Sender: TObject);
var
 vAux : String;
begin
if not(InputQuery('WebServices Enviar', 'Numero da Nota', vAux)) then
...
procedure TfrmNFeMonitor.btnConsCadClick(Sender: TObject);
var
 UF, Documento : String;
begin
...
procedure TfrmNFeMonitor.btnGerarPDFClick(Sender: TObject);
begin
  OpenDialog1.Title := 'Selecione a NFE';
  OpenDialog1.DefaultExt := '*-nfe.XML';
  OpenDialog1.Filter := 'Arquivos NFE (*-nfe.XML)|*-nfe.XML|Arquivos XML (*.XML)|*.XML|Todos os Arquivos (*.*)|*.*';
...
procedure TfrmNFeMonitor.btnEnviarEmailClick(Sender: TObject);
var
 Para : String;
 CC: Tstrings;
begin
...
procedure TfrmNFeMonitor.btnConsultarReciboClick(Sender: TObject);
var
  aux : String;
begin
...
procedure TfrmNFeMonitor.btnEnvDPECClick(Sender: TObject);
var
 vAux : String;
begin
...
procedure TfrmNFeMonitor.btnConsultarDPECClick(Sender: TObject);
var
 vAux : String;
begin
...
procedure TfrmNFeMonitor.ACBrNFe1GerarLog(const Mensagem: String);
begin
 memoLog.Lines.Add(Mensagem);
end;

procedure TfrmNFeMonitor.btnImportarXMLClick(Sender: TObject);
var
  i, j, k, n  : integer;
...
procedure TfrmNFeMonitor.lblMouseEnter(Sender: TObject);
begin
 TLabel(Sender).Font.Style := [fsBold,fsUnderline];
end;

procedure TfrmNFeMonitor.lblMouseLeave(Sender: TObject);
begin
 TLabel(Sender).Font.Style := [fsBold];
end;

procedure TfrmNFeMonitor.lblColaboradorClick(Sender: TObject);
begin
  ShellExecute(0, Nil, 'http://acbr.sourceforge.net/drupal/?q=node/5', Nil, Nil, SW_NORMAL);
end;

procedure TfrmNFeMonitor.lblPatrocinadorClick(Sender: TObject);
begin
  ShellExecute(0, Nil, 'http://acbr.sourceforge.net/drupal/?q=node/35', Nil, Nil, SW_NORMAL);
end;

procedure TfrmNFeMonitor.lblDoar1Click(Sender: TObject);
begin
  ShellExecute(0, Nil, 'http://acbr.sourceforge.net/drupal/?q=node/14', Nil, Nil, SW_NORMAL);
end;

procedure TfrmNFeMonitor.FormClose(Sender: TObject;
