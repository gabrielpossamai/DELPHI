object FContPag: TFContPag
  ...
  object ToolBarItem: TToolBar
    ...
    object btnexcluiritemcontpag: TToolButton
      Left = 31
      Top = 0
      Hint = 'Excluir'
      Caption = 'btnexcluiritemcontpag'
      ImageIndex = 5
      ParentShowHint = False
      ShowHint = True
      OnClick = btnexcluiritemcontpagClick
    end
  ...
  object QContPag: TSQLQuery
    ...
    Left = 76
    Top = 7
    object QContPagTOTAL: TFMTBCDField
      FieldName = 'TOTAL'
      DisplayFormat = '0.00'
      Precision = 15
      Size = 2
