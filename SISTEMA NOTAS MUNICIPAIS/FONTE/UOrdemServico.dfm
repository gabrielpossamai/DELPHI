object FOrdemServico: TFOrdemServico
  ...
  object PageControl: TPageControl
    ...
    object TabConsulta: TTabSheet
      ...
      object DBGrid2: TDBGrid
        ...
        TabStop = False
        Align = alBottom
        DataSource = DM.DSOrdemServicoServico
        Font.Charset = ANSI_CHARSET
        Font.Color = clNavy
        Font.Height = -11
        Font.Name = 'Comic Sans MS'
      ...
      object DBGrid4: TDBGrid
        ...
        TabStop = False
        Align = alBottom
        DataSource = DM.DSOrdemServicoProduto
        Font.Charset = ANSI_CHARSET
        Font.Color = clNavy
        Font.Height = -11
        Font.Name = 'Comic Sans MS'
    ...
    object TabCadastro: TTabSheet
      ...
      object PageControlCad: TPageControl
        ...
        object TabPrincipal: TTabSheet
          ...
          object btnplaca: TRxSpeedButton
            Left = 191
            Top = 24
            Width = 23
            Height = 20
          ...
          object btnvendedor: TRxSpeedButton
            Left = 191
            Top = 70
            Width = 23
            Height = 20
          ...
          object txtdata: TWSDBEdit
            ...
            ParentShowHint = False
            TabOrder = 1
            OnKeyDown = txtcodclienteKeyDown
            FocoAlterar = True
          ...
          object txtcodvendedor: TWSDBEdit
            Left = 90
            Top = 72
            Width = 100
            DataField = 'ORDVENDEDOR'
            DataSource = DataSource
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clGray
            Font.Height = -11
          ...
          object txtoperacao: TWSDBComboBox
            ...
            ParentShowHint = False
            TabOrder = 9
            OnExit = txtoperacaoExit
            OnKeyDown = txtcodclienteKeyDown
            ColorOnFocus = clBlack
            ColorOnNotFocus = clGray
          end
          object PageControlItem: TPageControl
            Left = 0
            Top = 122
            Width = 756
            Height = 228
            ...
            object TabProduto: TTabSheet
              ...
              object Panel1: TPanel
                ...
                object ToolBarItem: TToolBar
                  ...
                  Images = DM.ImageList
                  TabOrder = 3
                  object btnsalvarprod: TToolButton
                    Left = 0
                    Top = 0
                    Hint = 'Salvar'
                    Caption = 'btnsalvarprod'
                    ImageIndex = 14
                    ParentShowHint = False
                    ShowHint = True
                    OnClick = btnsalvarprodClick
                  end
                  object btnexcluirprod: TToolButton
                    Left = 31
                    Top = 0
                    Hint = 'Excluir'
                    Caption = 'btnexcluirprod'
                    ImageIndex = 5
                    ParentShowHint = False
                    ShowHint = True
                ...
                object txtprecoprod: TWSEdit
                  ...
                  TabOrder = 2
                  OnKeyDown = txtcodclienteKeyDown
                  OnKeyPress = txtprecoprodKeyPress
                  ColorOnFocus = clBlack
                  ColorOnNotFocus = clGray
                end
                object txtquantprod: TWSEdit
                  Left = 115
                  Top = 19
                  Width = 65
                  height = 17
            ...
            object TabServico: TTabSheet
              ...
              object Panel2: TPanel
                ...
                object btnservico: TRxSpeedButton
                  Left = 86
                  Top = 16
                  Width = 23
                  Height = 21
                ...
                object ToolBar1: TToolBar
                  ...
                  Images = DM.ImageList
                  TabOrder = 3
                  object btnsalvarserv: TToolButton
                    Left = 0
                    Top = 0
                    Hint = 'Salvar'
                  ...
                  object btnexcluirserv: TToolButton
                    Left = 31
                    Top = 0
                    Hint = 'Excluir'
                    ...
                    ParentShowHint = False
                    ShowHint = True
                    OnClick = btnexcluirservClick
                  end
                end
                object txtprecoserv: TWSEdit
                  Left = 185
                  Top = 19
                  Width = 65
                  height = 17
                  ...
                  TabOrder = 2
                  OnKeyDown = txtcodclienteKeyDown
                  OnKeyPress = txtprecoservKeyPress
                  ColorOnFocus = clBlack
                  ColorOnNotFocus = clGray
                end
                object txtquantserv: TWSEdit
                  Left = 115
                  Top = 19
                  Width = 65
                  height = 17
          ...
          object txtfone: TWSDBEdit
            Left = 474
            Top = 50
            Width = 111
            DataField = 'ORDTELEFONE'
            DataSource = DataSource
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clGray
            Font.Height = -11
        ...
        object TabSheet1: TTabSheet
          ...
          object DBGrid3: TDBGrid
            ...
            TabStop = False
            Align = alRight
            DataSource = DM.DSOrdemServicoVcto
            Font.Charset = ANSI_CHARSET
            Font.Color = clNavy
            Font.Height = -11
            Font.Name = 'Comic Sans MS'
  ...
  object PanPesquisa: TPanel
    ...
    object txtfiltrocliente: TWSEdit
      Left = 248
      Top = 3
      Width = 94
      height = 17
  ...
  object panimpressao: TPanel
    ...
    object btnrelmecanico: TSpeedButton
      Left = 6
      Top = 94
      Width = 147
      Height = 29
  ...
  object RLReportMecanico: TRLReport
    Left = 530
    Top = 462
    Width = 794
    Height = 1123
