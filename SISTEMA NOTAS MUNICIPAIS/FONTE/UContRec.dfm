object FContRec: TFContRec
  ...
  object ToolBarItem: TToolBar
    ...
    Images = DM.ImageList
    TabOrder = 3
    object btnsalvaritemcontrec: TToolButton
      Left = 0
      Top = 0
      Hint = 'Baixar/Desbaixar Parcela'
      Caption = 'btnsalvaritemcontrec'
      ImageIndex = 14
      ParentShowHint = False
      ShowHint = True
      OnClick = btnsalvaritemcontrecClick
    end
    object btnexcluiritemcontrec: TToolButton
      Left = 31
      Top = 0
      Hint = 'Excluir'
      Caption = 'btnexcluiritemcontrec'
      ImageIndex = 5
      ParentShowHint = False
      ShowHint = True
      OnClick = btnexcluiritemcontrecClick
    end
  ...
  object QContRec: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'FROM TITEMCONTREC'
      'WHERE UPPER(ITESITUACAO) = '#39'FECHADO'#39
      'AND ITEDOCUMENTO = :DOCTO')
    SQLConnection = DM.SQLConnection
    Left = 76
    Top = 7
    object QContRecTOTAL: TFloatField
      FieldName = 'TOTAL'
      DisplayFormat = '0.00'
    end
  end
  object QSituacao: TSQLQuery
    ...
    SQL.Strings = (
      'SELECT COUNT(ITEDOCUMENTO) AS CONTA'
      'FROM TITEMCONTREC'
      'WHERE UPPER(ITESITUACAO) = '#39'ABERTO'#39
      'AND ITEDOCUMENTO = :DOCTO')
    SQLConnection = DM.SQLConnection
    Left = 116
    Top = 7
