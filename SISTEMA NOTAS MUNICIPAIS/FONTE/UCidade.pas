    ...
    if (DataSource.DataSet.Active = true) then
      if (DataSource.DataSet.RecordCount > 0) then
        ...
        begin
            ...
            integridade('NOTCIDADE', 'TNOTAFISC', WSDBEdit1.text);
            integridade('NOTCIDADE', 'TNOTAENT', WSDBEdit1.text);
            integridade('IMOCIDADE', 'TIMOVEL', WSDBEdit1.text);            
            try
