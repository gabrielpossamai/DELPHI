object FContRecRel: TFContRecRel
  Left = 16
  Top = 9
  Width = 1007
  Height = 740
  ...
  object Qvcto: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'SELECT RECDOCUMENTO, RECEMISSAO, RECVALOR, CLINOME, ITEDATA, ITE' +
        'VALOR, ITEPAGAMENTO, ITESITUACAO'
      'FROM TCONTREC'
      '    LEFT OUTER JOIN TCLIENTE ON CLICOD = RECCLIENTE'
      '    LEFT OUTER JOIN TBANCO ON BANCOD = RECBANCO'
      '    INNER JOIN TITEMCONTREC ON ITEDOCUMENTO = RECDOCUMENTO'
      'WHERE RECDOCUMENTO > 0'
      'ORDER BY ITEDATA, CLINOME, RECDOCUMENTO')
    ...
    object QvctoITEVALOR: TFloatField
      FieldName = 'ITEVALOR'
    end
  ...
  object CDSVcto: TClientDataSet
    ...
    object CDSVctoITEVALOR: TFloatField
      FieldName = 'ITEVALOR'
      DisplayFormat = '0.00'
    end
