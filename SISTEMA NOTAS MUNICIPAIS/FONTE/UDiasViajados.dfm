object FDiasViajados: TFDiasViajados
  Left = 224
  Top = 126
  BorderIcons = []
  ...
  object PageControl: TPageControl
    ...
    object TabCadastro: TTabSheet
      ...
      object btnestudante: TRxSpeedButton
        Left = 184
        Top = 4
        Width = 23
        Height = 21
      ...
      object txtcodestudante: TWSDBEdit
        Left = 93
        Top = 6
        Width = 88
        DataField = 'DIAALUNO'
      ...
      object txtsegunda: TDBRadioGroup
        Left = 9
        Top = 49
        Width = 105
        Height = 33
  ...
  object PanPesquisa: TPanel
    ...
    object btnfiltroestudante: TRxSpeedButton
      Left = 120
      Top = 10
      Width = 23
      Height = 22
      ...
      Glyph.Data = {
        ...
        1F7C1F7C1F7C}
      ShowHint = False
      OnClick = btnfiltroestudanteClick
    end
    ...
    object txtfiltroestudante: TWSEdit
      Left = 63
      Top = 13
      Width = 55
      height = 17
    ...
    object txtdiadasemana: TWSComboBox
      Left = 392
      Top = 10
      Width = 93
      Height = 23
  ...
  object panimpressao: TPanel
    ...
    object btnaniversarios: TSpeedButton
      Left = 6
      Top = 80
      Width = 147
      Height = 29
      Caption = 'Por Dia da Semana'
      Flat = True
      Font.Charset = ANSI_CHARSET
      Font.Color = clTeal
      Font.Height = -11
  ...
  object RLReport: TRLReport
    ...
    object RLBand3: TRLBand
      ...
      object RLTitulo: TRLLabel
        ...
        Align = faCenter
        Alignment = taCenter
        Caption = 'Relat'#243'rio de Estudantes'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Height = -21
        Font.Name = 'Comic Sans MS'
  ...
  object RLReportDiaSemana: TRLReport
    Left = 36
    Top = 395
    Width = 794
    Height = 1123
    ...
    object RLBand9: TRLBand
      ...
      object lbldiadasemana: TRLLabel
        Left = 108
        Top = 3
        Width = 47
        Height = 16
  ...
  object DataSource: TDataSource
    DataSet = DM.CDSDiasViajados
    Left = 8
    Top = 8
  end
  object WSInformacao: TWSInformacao
    Tabela = 'TDIASVIAJADOS'
    Programa = 65
    Campo = 'DIAALUNO'
    Left = 40
    Top = 8
