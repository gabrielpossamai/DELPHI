object FFactoryDoctoProb: TFFactoryDoctoProb
  Left = 194
  Top = 106
  BorderIcons = []
  ...
  object lbltitulo: TLabel
    ...
    Align = alTop
    Alignment = taCenter
    Caption = 'Factory - Lan'#231'amentos de Documentos com Problemas'
  ...
  object PageControl: TPageControl
    ...
    object TabCadastro: TTabSheet
      ...
      object Label12: TLabel
        ...
        Width = 78
        Height = 16
        Caption = 'N'#176' Devolu'#231#245'es'
        Font.Charset = ANSI_CHARSET
        Font.Color = clTeal
        Font.Height = -11
        Font.Name = 'Comic Sans MS'
  ...
  object DataSource: TDataSource
    DataSet = DM.CDSFactoryDoctoProb
    Left = 8
    Top = 8
  end
  object WSInformacao: TWSInformacao
    Tabela = 'TFACTORYDOCTOPROB'
    Programa = 38
    Left = 40
    Top = 8
  end
