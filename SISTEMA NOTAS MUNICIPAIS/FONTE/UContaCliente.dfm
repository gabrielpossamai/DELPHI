object FContaCliente: TFContaCliente
  Left = 282
  Top = 128
  BorderIcons = []
  ...
  object PageControl: TPageControl
    ...
    object TabCadastro: TTabSheet
      ...
      object Label6: TLabel
        ...
        Width = 106
        Height = 16
        Caption = '(D)'#233'bito - (C)r'#233'dito'
        Font.Charset = ANSI_CHARSET
        Font.Color = clTeal
        Font.Height = -11
        Font.Name = 'Comic Sans MS'
  ...
  object PanPesquisa: TPanel
    ...
    object btnfiltrocliente: TRxSpeedButton
      Left = 580
      Top = 3
      Width = 23
      Height = 22
  ...
  object DataSource: TDataSource
    DataSet = DM.CDSContaCliente
    Left = 8
    Top = 8
  end
  object WSInformacao: TWSInformacao
    Tabela = 'TCONTACLIENTE'
    Programa = 25
    Left = 40
    Top = 8
  end
