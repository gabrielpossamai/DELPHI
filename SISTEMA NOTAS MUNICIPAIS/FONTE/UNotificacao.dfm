object FNotificacao: TFNotificacao
  Left = 192
  Top = 103
  BorderIcons = []
  ...
  object PageControl: TPageControl
    ...
    object TabCadastro: TTabSheet
      ...
      object btnexcesso: TRxSpeedButton
        Left = 215
        Top = 97
        Width = 23
        Height = 22
      ...
      object txtpesagem: TWSDBEdit
        Left = 90
        Top = 63
        Width = 119
        DataField = 'NOTPESAGEM'
        DataSource = DataSource
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clGray
        Font.Height = -11
      ...
      object txtexcesso: TWSDBEdit
        Left = 90
        Top = 100
        Width = 121
        DataField = 'NOTEXCESSO'
        DataSource = DataSource
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clGray
        Font.Height = -11
