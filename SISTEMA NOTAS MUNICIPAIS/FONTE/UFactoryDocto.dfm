object FFactoryDocto: TFFactoryDocto
  Left = 129
  Top = 81
  BorderIcons = []
  ...
  object lbltitulo: TLabel
    ...
    Align = alTop
    Alignment = taCenter
    Caption = 'Factory - Lan'#231'amentos de Documentos'
  ...
  object panimpressao: TPanel
    ...
    object btncontrato: TSpeedButton
      Left = 6
      Top = 106
      Width = 147
      Height = 29
  ...
  object ToolBar1: TToolBar
    ...
    Images = DM.ImageList
    TabOrder = 4
    object btnsalvaritemcontpag: TToolButton
      Left = 0
      Top = 0
      Hint = 'Baixar/Desbaixar Cheque'
      Caption = 'btnsalvaritemcontpag'
      ImageIndex = 14
      ParentShowHint = False
      ShowHint = True
      OnClick = btnsalvaritemcontpagClick
    end
  end
  object DataSource: TDataSource
    DataSet = DM.CDSFactoryDocto
    Left = 8
    Top = 8
  end
  object WSInformacao: TWSInformacao
    Tabela = 'TFACTORYDOCTO'
    Programa = 37
    Left = 40
    Top = 8
  end
