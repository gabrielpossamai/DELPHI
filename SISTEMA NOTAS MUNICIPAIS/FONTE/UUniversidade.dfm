object FUniversidade: TFUniversidade
  Left = 71
  Top = 116
  BorderIcons = []
  ...
  object lbltitulo: TLabel
    ...
    Align = alTop
    Alignment = taCenter
    Caption = 'Cadastro de Universidades'
  ...
  object RLReport: TRLReport
    ...
    object RLBand3: TRLBand
      ...
      object RLLabel1: TRLLabel
        ...
        Align = faCenter
        Alignment = taCenter
        Caption = 'Relat'#243'rio de Universidades'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Height = -21
        Font.Name = 'Comic Sans MS'
  ...
  object DataSource: TDataSource
    DataSet = DM.CDSUniversidade
    Left = 8
    Top = 8
  end
  object WSInformacao: TWSInformacao
    Tabela = 'TUNIVERSIDADE'
    Programa = 60
    Left = 40
    Top = 8
  end
